...
public class Validate {
    ...
    public static String getNameAccount(String prompt) {
        Service<Account> service = new ServiceAccount();
        while (true) {
            System.out.println(prompt);
            String value = sc.nextLine().trim();
            if (!value.isEmpty()) {
                value = value.replaceAll("\\s+", "");
                if (service.checkNameAccount(new RepositoryAccount(), new DataHandler(), value)) {
                    return value;
                } else {
    ...
    public static String getAccountNumber(String prompt) {
        ...
        while (true) {
            ...
            if (isValid) {
                boolean isNameAccount = service.checkNumberAccount(new RepositoryAccount(), new DataHandler(), value);
                if (isNameAccount) {
                    return value;
                } else {
